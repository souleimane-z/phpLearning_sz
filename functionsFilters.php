...
<body>
    <div>
        ...
        <p style="text-align: center; font-size:18px;">(functions)</p>
    </div>
    <?php 
    $img = 'https://fivebooks.com/app/uploads/2020/08/most-recommended-books-share-image.jpg';
    ...
    <table>
        <thead>
            <tr>
                <th colspan="2" id="tableHeader">📚 A function that showing books only written by Philip K. DICK 📚</th>
            </tr>
        </thead>
    </table>
